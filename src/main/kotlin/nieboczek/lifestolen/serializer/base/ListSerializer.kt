...
class ListSerializer<T>(private val elementSerializer: Serializer<T>) : Serializer<List<T>>() {
    override fun serialize(value: List<T>, builder: SerializedStringBuilder) {
    ...
    override fun deserialize(stream: TokenStream): List<T> {
